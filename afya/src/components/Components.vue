								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="avatar avatar-away mr-1">
												<img class="avatar-img rounded-circle" alt="User Image" src="../assets/img/patients/patient8.jpg">
											</div>
										</div>
									</div>
						...
						<section class="comp-section comp-buttons">
							...
							<div class="card">
								<div class="card-body">
									...
									<p>
										...
										<button type="button" class="btn btn-dark btn-lg mr-1">Dark</button>
									</p>
									<p>
										<button type="button" class="btn btn-primary mr-1">Primary</button>
										<button type="button" class="btn btn-secondary mr-1">Secondary</button>
									...
									<p>
										...
										<button type="button" class="btn btn-dark btn-sm mr-1">Dark</button>
									</p>
									<hr>
									...
									<div class="btn-toolbar">
										<div class="btn-group btn-group-lg">
											...
											<button type="button" class="btn btn-primary mr-1">Right</button>
										</div>
									</div>
									<br>
									<div class="btn-toolbar">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<button type="button" class="btn btn-rounded btn-dark mr-1">Dark</button>
									<hr>
									...
									<button type="button" class="btn btn-rounded btn-outline-dark mr-1">Dark</button>
								</div>
							</div>
							<!-- /Rounded Button -->
