				...
				<div class="container">
					<div class="row heading-wrapper">
						...
						<div class="col-md-6 text-right">
							<a href="#" class="nav-arrow"><i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
					<div class="row">
							...
							<div class="book-slider slider">
								<div class="profile-widget">
									...
									<div class="pro-content">
										...
										<div class="provider-info">
											<h3><router-link to="/doctor/profile">Dr. Marvin Paul</router-link></h3>
											<h5>PSICOLOGIST </h5>
											<div class="rating">
								...
								<div class="profile-widget">
									...
									<div class="pro-content">
										...
										<div class="provider-info">
											<h3><router-link to="/doctor/profile">Dr. Linda Tobin</router-link></h3>
											<h5>PSICOLOGIST </h5>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
								...
								<div class="profile-widget">
									...
									<div class="pro-content">
										...
										<div class="provider-info">
											<h3><router-link to="/doctor/profile">Dr. Paul Richard</router-link></h3>
											<h5>PSICOLOGIST </h5>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
								...
								<div class="profile-widget">
									...
									<div class="pro-content">
										...
										<div class="provider-info">
											<h3><router-link to="/doctor/profile">Dr. Ruby Perrin</router-link></h3>
											<h5>PSICOLOGIST </h5>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
								...
								<div class="profile-widget">
									...
									<div class="pro-content">
										...
										<div class="provider-info">
											<h3><router-link to="/doctor/profile">Dr. Darren Elder</router-link></h3>
											<h5>PSICOLOGIST </h5>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
							...
							<div class="blog-wrapper">
								...
								<div class="wrap-content">
									...
									<div class="wrap-content-body">
										<h3><router-link to="/doctor/blog-details">AfyaYetu – Making your clinic painless visit?</router-link></h3>
