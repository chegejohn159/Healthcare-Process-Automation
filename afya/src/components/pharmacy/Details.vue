							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										<h4 class="doc-name mb-2"><router-link to="/pharmacy/details">Medlife Medical</router-link></h4>
								...
								<div class="doc-info-right d-flex align-items-center justify-content-center">
									<div class="clinic-booking">
										<router-link class="view-pro-btn" to="/patient/chat">Send Message</router-link>
										<a class="apt-btn" href="#" data-toggle="modal" data-target="#voice_call">Call Now</a>
										<router-link to="/pharmacy/product" class="view-pro-btn">Browse Products</router-link>
									</div>
								</div>
							</div>
											...
											<div class="col-md-6">
												<div class="clinic-content">
													...
													<div class="clinic-details mb-0">
														...
														<ul>
															<li class="mr-1">
																<a class="fancystyle" href="../../assets/img/features/feature-01.jpg" data-fancybox="gallery2">
																	<img src="../../assets/img/features/feature-01.jpg" alt="Feature Image">
																</a>
															</li>
															<li class="mr-1">
																<a class="fancystyle" href="../../assets/img/features/feature-02.jpg" data-fancybox="gallery2">
																	<img src="../../assets/img/features/feature-02.jpg" alt="Feature Image">
																</a>
															</li>
															<li class="mr-1">
																<a class="fancystyle" href="../../assets/img/features/feature-03.jpg" data-fancybox="gallery2">
																	<img src="../../assets/img/features/feature-03.jpg" alt="Feature Image">
																</a>
															</li>
															<li class="mr-1">
																<a class="fancystyle" href="../../assets/img/features/feature-04.jpg" data-fancybox="gallery2">
												...
												<div class="comment">
													...
													<div class="comment-body">
														<div class="meta-data">
															...
															<div class="review-count rating favouritesrating">
																<i class="fas fa-star filled"></i>
																<i class="fas fa-star filled"></i>
																<i class="fas fa-star filled"></i>
																<i class="fas fa-star filled"></i>
