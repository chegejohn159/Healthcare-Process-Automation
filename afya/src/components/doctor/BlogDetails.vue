									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<router-link to="/doctor/profile"><img class="img-fluid rounded-circle" alt="" src="../../assets/img/doctors/doctor-thumb-02.jpg"></router-link>
											</div>
										</div>
										<div class="author-details">
											<router-link to="/doctor/profile" class="blog-author-name">Dr. Darren Elder</router-link>
