            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="blog blog-single-post">
                            ...
                            <h3 class="blog-title">AfyaYetu – Making your clinic painless visit?</h3>
                            <div class="blog-info clearfix">
                                <div class="post-left">
                                    <ul>
                                        <li>
                                            <div class="post-author">
                                                <router-link to="/admin/doctorprofile"><img src="../../assets/admin_img/doctors/doctor-thumb-02.jpg" alt="Post Author"> <span>Dr. Darren Elder</span></router-link>
                                            </div>
                                        </li>
                            ...
                            <div class="about-author">
                                <div class="about-author-img">
                                    <div class="author-img-wrap">
                                        <router-link to="/admin/doctorprofile"><img class="img-fluid rounded-circle" alt="" src="../../assets/admin_img/doctors/doctor-thumb-02.jpg"></router-link>
                                    </div>
                                </div>
                                <div class="author-details">
                                    <router-link to="/admin/doctorprofile" class="blog-author-name">Dr. Darren Elder</router-link>
