																	...
																	<tr v-for="item in patientappointments" :key="item.id">
																		...
																		<td class="text-right">
																			<div class="table-action" v-if="item.action_status == 1 ||  item.action_status == 2">
																				<a href="javascript:void(0);" class="btn btn-sm bg-success-light mr-1">
																					<i class="far fa-edit"></i> Edit
																				</a>
																			</div>
																			<div class="table-action" v-else-if="item.action_status == 3">
																				<router-link to="/doctor/edit-prescription" class="btn btn-sm bg-success-light mr-1">
																					<i class="far fa-edit"></i> Edit
																				</router-link>
																				<a href="javascript:void(0);" class="btn btn-sm bg-danger-light mr-1">
																	...
																	<tr v-for="item in prescriptions" :key="item.id">
																		...
																		<td class="text-right">
																			<div class="table-action" >
																				<a href="javascript:void(0);" v-if="item.action_status == 1 || item.action_status == 2" class="btn btn-sm bg-primary-light mr-1">
																					<i class="fas fa-print"></i> Print
																				</a>
																				<a href="javascript:void(0);" v-if="item.action_status == 1 || item.action_status == 2" class="btn btn-sm bg-info-light mr-1">
																					<i class="far fa-eye"></i> View
																				</a>
																				<router-link to="/doctor/edit-prescription" v-if="item.action_status == 2" class="btn btn-sm bg-success-light mr-1">
																	...
																	<tr v-for="item in medicalrecords" :key="item.id">
																		...
																		<td class="text-right">
																			<div class="table-action" >
																				...
																				<a  v-if="item.action_status == 2" class="btn btn-sm bg-success-light mr-1" data-toggle="modal" data-target="#add_medical_records">
																					<i class="fas fa-edit"></i> Edit
																				</a>
																				<a href="javascript:void(0);" v-if="item.action_status == 2" class="btn btn-sm bg-danger-light">
																					<i class="far fa-trash-alt"></i> Delete
																		...
																		<td class="text-right">
																			<div class="table-action">
																				...
																				<a href="javascript:void(0);" v-if="item.action_status == 1 || item.action_status == 2" class="btn btn-sm bg-info-light mr-1">
																					...
																					<router-link to="/doctor/edit-billing" v-if="item.action_status == 2" class="btn btn-sm bg-success-light mr-1">
																					<i class="fas fa-edit"></i> Edit
																				</router-link>
																				<a href="javascript:void(0);" v-if="item.action_status == 2" class="btn btn-sm bg-danger-light">
																					<i class="far fa-trash-alt"></i> Delete
