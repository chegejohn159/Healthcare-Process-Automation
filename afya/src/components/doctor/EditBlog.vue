								...
								<div class="row mb-5">
                                    <div class="col">
                                        <ul class="nav nav-tabs nav-tabs-solid">
                                            <li class="nav-item">
                                                <router-link class="nav-link" to="/doctor/blogs">Acitive Blog</router-link>
                                            </li>
                                            <li class="nav-item">
									...
									<div class="card-body">
										...
										<form>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="form-group">
															...
															<input class="form-control" type="text" name="service_title" id="service_title" value="AfyaYetu – Making your clinic painless visit?" required="">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="submit-section">
												<button class="btn btn-primary submit-btn" @click="addblog" name="form_submit" value="submit">Submit</button>
											</div>
										</form>
