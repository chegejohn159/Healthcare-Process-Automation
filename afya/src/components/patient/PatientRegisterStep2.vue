								...
								<div class="inner-right-login">
									<div class="login-header">
										...
										<form id="personal_details" enctype="multipart/form-data">
					                        ...
					                        <div class="mt-5">
					                        	<router-link to="/patient/patient-register-step3" class="btn btn-primary btn-block btn-lg login-btn step2_submit" id="step2_button" type="submit">continue </router-link>
					                        </div>
				                        </form>
									</div>
								</div>
