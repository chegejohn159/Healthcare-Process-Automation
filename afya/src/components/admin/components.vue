                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="avatar avatar-xxl mr-1">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="avatar avatar-offline mr-1">
                                            <img class="avatar-img rounded-circle" alt="User Image" src="../../assets/admin_img/profiles/avatar-02.jpg">
                                        </div>
                    ...
                    <section class="comp-section comp-buttons">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>
                                    <button type="button" class="btn btn-primary btn-lg mr-1">Primary</button>
                                    <button type="button" class="btn btn-secondary btn-lg mr-1">Secondary</button>
                                    <button type="button" class="btn btn-success btn-lg mr-1">Success</button>
                                    <button type="button" class="btn btn-danger btn-lg mr-1">Danger</button>
                                    <button type="button" class="btn btn-warning btn-lg mr-1">Warning</button>
                                    <button type="button" class="btn btn-info btn-lg mr-1">Info</button>
                                    <button type="button" class="btn btn-light btn-lg mr-1">Light</button>
                                ...
                                <p>
                                    <button type="button" class="btn btn-primary btn-sm mr-1">Primary</button>
                                    <button type="button" class="btn btn-secondary btn-sm mr-1">Secondary</button>
                                    <button type="button" class="btn btn-success btn-sm mr-1">Success</button>
                                    <button type="button" class="btn btn-danger btn-sm mr-1">Danger</button>
                                    <button type="button" class="btn btn-warning btn-sm mr-1">Warning</button>
                                    <button type="button" class="btn btn-info btn-sm mr-1">Info</button>
                                    <button type="button" class="btn btn-light btn-sm mr-1">Light</button>
                                ...
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-lg">
                                        ...
                                        <button type="button" class="btn btn-primary mr-1">Middle</button>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-rounded btn-primary mr-1">Primary</button>
                                <button type="button" class="btn btn-rounded btn-secondary mr-1">Secondary</button>
                                <button type="button" class="btn btn-rounded btn-success mr-1">Success</button>
                                <button type="button" class="btn btn-rounded btn-danger mr-1">Danger</button>
                                <button type="button" class="btn btn-rounded btn-warning mr-1">Warning</button>
                                <button type="button" class="btn btn-rounded btn-info mr-1">Info</button>
                                <button type="button" class="btn btn-rounded btn-light mr-1">Light</button>
                                ...
                                <button type="button" class="btn btn-rounded btn-outline-primary mr-1">Primary</button>
                                <button type="button" class="btn btn-rounded btn-outline-secondary mr-1">Secondary</button>
                                <button type="button" class="btn btn-rounded btn-outline-success mr-1">Success</button>
                                <button type="button" class="btn btn-rounded btn-outline-danger mr-1">Danger</button>
                                <button type="button" class="btn btn-rounded btn-outline-warning mr-1">Warning</button>
                                <button type="button" class="btn btn-rounded btn-outline-info mr-1">Info</button>
                                <button type="button" class="btn btn-rounded btn-outline-light mr-1">Light</button>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary mr-1"><span class="spinner-border spinner-border-sm mr-2" role="status"></span>Primary</button>
                                <button type="button" class="btn btn-secondary mr-1"><span class="spinner-border spinner-border-sm mr-2" role="status"></span>Secondary</button>
                                <button type="button" class="btn btn-success mr-1"><span class="spinner-border spinner-border-sm mr-2" role="status"></span>Success</button>
                                <button type="button" class="btn btn-danger mr-1"><span class="spinner-border spinner-border-sm mr-2" role="status"></span>Danger</button>
                                <button type="button" class="btn btn-warning mr-1"><span class="spinner-border spinner-border-sm mr-2" role="status"></span>Warning</button>
                                <button type="button" class="btn btn-info mr-1"><span class="spinner-border spinner-border-sm mr-2" role="status"></span>Info</button>
                    ...
                    <section class="comp-section comp-dropdowns">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-secondary dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                        <div class="dropdown-divider"></div>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                        <div class="dropdown-divider"></div>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                        <div class="dropdown-divider"></div>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-warning dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                        <div class="dropdown-divider"></div>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                        <a class="dropdown-item" href="#">Another action</a>
                                        <div class="dropdown-divider"></div>
                ...
                <!-- Modals -->
                            <section class="comp-section">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                    <!-- Simple demo-->
                                    <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Simple</button>
                                    ...
                                    <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#exampleModalLong" data-original-title="" title="">Scrolling long content</button>
                                    ...
                                    <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#exampleModalCenter" data-original-title="" title="">Vertically centered</button>
                                    ...
                                    <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#tooltipmodal" data-original-title="" title="">Tooltips and popovers</button>
                                    ...
                                    <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#grid-modal" data-original-title="" title="">Using the grid</button>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body btn-showcase">
                                        <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#exampleModalfat" data-whatever="@mdo" data-original-title="" title="">Open modal for @mdo</button>
                                        <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#exampleModalmdo" data-whatever="@fat" data-original-title="" title="">Open modal for @fat</button>
                                        <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap" data-original-title="" title="">Open modal for @getbootstrap</button>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                    <!-- Extra Large modal -->
                                    <button type="button" class="btn btn-primary mr-1" data-toggle="modal" data-target=".bd-example-modal-xl">Extra large modal</button>
                                    ...
                                    <!-- Large modal-->
                                    <button class="btn btn-primary mr-1" type="button" data-toggle="modal" data-target=".bd-example-modal-lg" data-original-title="" title="">Large modal</button>
